...
const RegisterMain = () => {
    ...
    return (
        <>
            <div className="relative w-[1920px] h-[1301px] bg-[#fff] overflow-hidden">
                <div className="absolute left-0 top-[161px] w-[1920px] h-[908px]">
                    <div className="absolute left-0 top-0 w-[1920px] h-[938px] bg-[#fff]"></div>
                    <div className="absolute left-0 top-[84px] w-[1920px] h-[94px] text-[40px] font-['Inter'] font-bold text-[#000] text-center">회원가입</div>
                    ...
                    <img className="absolute left-[932px] top-[350px]" width="56" height="64" src="/img/user/user (1) 186_54.png"></img>
                    {/* <button className="absolute left-[868px] top-[607px] w-[184px] h-[60px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[50px]"></button> */}
                    {/* <div className="absolute left-[930px] top-[627px] text-[16px] font-['Inter'] text-[#0b2d85] whitespace-nowrap">가입하기</div> */}
                    <div className="absolute left-[-1px] top-[908px] w-[1920px] h-[232px] bg-[#000] overflow-hidden">
                ...
                <div className="absolute left-0 top-0 w-[1920px] h-[161px] overflow-hidden">
                    <div className="absolute left-0 top-0 w-[1920px] h-[155px] flex">
                        ...
                        <div className="absolute left-0 top-0 w-[1920px] h-[31px] flex">
                            <div className="absolute left-0 top-0 w-[1920px] h-[31px] flex">
                                ...
                                <div className="absolute left-0 top-[4px] w-[1920px] h-[27px] flex">
                                    ...
                                    <div className="absolute left-[1778px] top-0 w-[87px] h-[27px] text-[16px] font-['Inter'] text-[#fff] text-center">회원가입</div>
                                    ...
                                    <div className="absolute left-[1697px] top-0 w-[76px] h-[27px] text-[16px] font-['Inter'] text-[#fff] text-center">로그인</div>
                        ...
                        <div className="absolute left-[857px] top-0 w-[207px] h-[155px] flex">
                            ...
                            <img className="absolute left-[2.21%] right-[2.8%] top-0 bottom-[2.63%]" width="196" height="150" src="/img/user/line145_863.png"></img>
            ...
            <button
                ...
                className="absolute left-[868px] top-[777px] w-[184px] h-[60px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[50px]"
            >
            <span className="text-[16px] font-['Inter'] text-[#0b2d85]">가입하기</span>
            </button>
        </>)
