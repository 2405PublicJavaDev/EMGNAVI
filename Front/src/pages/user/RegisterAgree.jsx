...
const RegisterAgree = () => {
    return (<div className="relative w-[1920px] h-[2484px] bg-[#fff] overflow-hidden">
        ...
        <img className="absolute left-[1288px] top-[1333px]" width="20" height="20" src="/img/user/check-mark (1) 1299_37.png"></img>
        ...
        <img className="absolute left-[1288px] top-[753px]" width="20" height="20" src="/img/user/check-mark (1) 1343_312.png"></img>
