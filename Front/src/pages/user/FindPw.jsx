...
const FindPw = () => {
    return (<div className="relative w-[1920px] h-[1587px] bg-[#fff] overflow-hidden">
        ...
        <div className="absolute left-[760px] top-[671px] w-[459px] h-[52px] text-[17px] font-['Inter'] text-[#7d8597] flex flex-col justify-center">아이디(이메일)를 입력해주세요.</div>
        <div className="absolute left-[1248px] top-[671px] w-[103px] h-[52px] flex">
            <div className="absolute left-0 top-0 w-[103px] h-[52px] bg-[#0b2d85] border-[1px] border-solid border-[#fff] rounded-[5px]"></div>
            <div className="absolute left-0 top-0 w-[103px] h-[52px] text-[18px] font-['Inter'] font-bold text-[#fff] text-center flex flex-col justify-center">전송</div>
        </div>
