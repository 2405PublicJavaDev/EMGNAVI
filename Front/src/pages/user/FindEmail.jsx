    ...
    return (
        <>
            <div className="relative w-[1920px] h-[1505px] bg-[#fff] overflow-hidden">
                <div className="absolute left-[137px] top-[425px] w-[1646px] h-[466px] bg-[#7d85971a] rounded-[20px]"></div>
                <img className="absolute left-[918px] top-[507px]" width="72" height="72" src="/img/user/smartphone 2177_1385.png"></img>
                <img className="absolute left-[965px] top-[533px]" width="37" height="37" src="/img/user/checked (1) 2177_1386.png"></img>
                <div className="absolute left-0 top-[1273px] w-[1920px] h-[232px] bg-[#000] overflow-hidden">
                    ...
                    <div className="absolute left-[390px] top-[62px] w-[638px] h-[115px] flex">
                        <div className="absolute left-0 top-[54px] w-[638px] h-[61px] flex">
                            ...
                            <img className="absolute left-[2px] top-[27px]" width="9" height="8" src="/img/user/copyright (1) 1177_1401.png"></img>
                        </div>
                        <div className="absolute left-0 top-0 w-[221px] h-[21px] text-[15px] leading-[150%] font-['Agdasima'] font-bold text-[#686868]">이용약관              개인정보처리방침</div>
                    </div>
                    <img className="absolute left-[1634px] top-[47px]" width="145" height="34" src="/img/user/Group 17177_1403.png"></img>
                </div>
                <div className="absolute left-0 top-0 w-[1920px] h-[161px] overflow-hidden">
                    <div className="absolute left-0 top-0 w-[1920px] h-[155px] flex">
                        ...
                        <div className="absolute left-[857px] top-0 w-[207px] h-[155px] flex">
                            <img className="absolute left-0 right-0 top-0 bottom-0" width="206" height="154" src="/img/user/bg279_264.png"></img>
                            <img className="absolute left-[2.21%] right-[2.8%] top-0 bottom-[2.63%]" width="196" height="150" src="/img/user/line279_265.png"></img>
                            <div className="absolute left-[24px] top-[6px] w-[159px] h-[123px] flex">
                                ...
                                <img className="absolute left-[24px] top-0" width="111" height="97" src="/img/user/file 1279_268.png"></img>
                            </div>
                        </div>
                    </div>
                ...
                <div className="absolute left-0 top-[638px] w-[1920px] h-[51px] text-[26px] font-['Inter'] font-semibold text-[#000] text-center">휴대폰 본인인증</div>
                ...
                <button onClick={openModal} className="absolute left-[862px] top-[748px] w-[184px] h-[60px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[50px]">
                    <span className="text-[16px] font-['Inter'] text-[#0b2d85] text-center flex flex-col justify-center">인증하기</span>
                </button>
                <div className="absolute left-[770px] top-[978px] w-[390px] h-[60px] flex">
