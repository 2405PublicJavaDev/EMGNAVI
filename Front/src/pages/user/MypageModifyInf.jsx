...
const MypageModifyInf = () => {
    return (<div className="relative w-[1920px] h-[2139px] bg-[#fff] overflow-hidden">
        ...
        <div className="absolute left-0 top-[1907px] w-[1920px] h-[232px] bg-[#000] overflow-hidden">
        ...
        <div className="absolute left-[748px] top-[678px] w-[121px] h-[51px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[45px]"></div>
        <div className="absolute left-[748px] top-[678px] w-[121px] h-[51px] text-[17px] font-['Inter'] text-[#000] text-center flex flex-col justify-center">변경하기</div>
        <div className="absolute left-[894px] top-[891px] w-[121px] h-[51px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[45px]"></div>
        <div className="absolute left-[894px] top-[891px] w-[121px] h-[51px] text-[17px] font-['Inter'] text-[#000] text-center flex flex-col justify-center">변경하기</div>
