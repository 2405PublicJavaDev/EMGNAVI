        ...
        <>
            ...
            <form id="form" onSubmit={handleRegister} autoComplete='off'>
                ...
                <button
                    ...
                    disabled={idImageSrc !== "/img/user/green.png"}
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        handlerPwChange(e.target.value)
                ...
                <input
                    ...
                    onChange={(e) => {
                        const value = e.target.value;
                        handlerConfirmPwChange(e.target.value)
                        setValues({ ...values, uCPassword: value });
                    }}
                ...
                <input
                    ...
                    className="absolute left-[775px] top-[1128px] w-[399px] h-[53px] text-[17px] font-['Inter'] text-[#000] flex flex-col justify-center outline-0">
                </input>
                <img
                ...
                <div className="absolute left-[748px] top-[1242px] w-[214px] text-[17px]     font-['Inter'] text-[#000]">{userPhone}</div>
                ...
                <input
                    ...
                    onChange={(e) => {
                        const value = e.target.value;
                        setValues({ ...values, uName: value });
                    }}
                    className="absolute left-[775px] top-[1324px] w-[479px] h-[53px] text-[17px] font-['Inter'] text-[#7d8597] flex flex-col justify-center outline-0">
                </input>
