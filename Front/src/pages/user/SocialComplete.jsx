...
const SocialComplete = () => {
    ...
    return (<>
        <div className="absolute left-[265px] top-[400px] w-[1390px] h-[466px] bg-[#7d85971a] rounded-[20px]"></div>
        <div className="absolute left-0 top-[630px] w-[1919px] h-[47px] text-[26px] font-['Inter'] font-semibold text-center"><span className="text-[#0b2d85]">{userNickname}</span><span className="text-[#000]"> 님, 환영합니다.</span></div>
        <div className="absolute left-0 top-[695px] w-[1919px] h-[77px] text-[20px] leading-[150%] font-['Inter'] text-[#000] text-center">회원가입이 완료되었습니다.<br />응급NAVI 홈페이지에 가입해주셔서 감사합니다.</div>
        <div className="absolute left-0 top-[245px] w-[1919px] h-[47px] text-[40px] font-['Inter'] font-bold text-[#000] text-center">소셜 회원가입</div>
        ...
        <div className="absolute left-[766px] top-[953px] w-[387px] h-[60px] flex">
        ...
        <img className="absolute left-[917px] top-[488px]" width="56" height="64" src="/img/user/user.png"></img>
        <img className="absolute left-[966px] top-[497px]" width="36" height="36" src="/img/user/checked (1) 2324_219.png"></img>
        <div className="absolute left-0 top-[1125px] w-[1920px] h-[232px] bg-[#000] overflow-hidden">
