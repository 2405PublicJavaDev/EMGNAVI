...
const RegisterVerify = () => {
    ...
    return (
        <>
            <div className="relative w-[1920px] h-[1859px] bg-[#fff] overflow-hidden">
                <div className="absolute left-[243px] top-[930px] w-[1435px] h-[466px] bg-[#7d85971a] rounded-[20px]"></div>
                <img className="absolute left-[920px] top-[1034px]" width="69" height="69" src="/img/user/smartphone 1101_3.png"></img>
                <div className="absolute left-[243px] top-[1166px] w-[1435px] h-[30px] text-[26px] font-['Inter'] font-semibold text-[#000] text-center">휴대폰 본인인증</div>
                <img className="absolute left-[966px] top-[1059px]" width="34" height="35" src="/img/user/checked (1) 1107_6.png"></img>
                <div className="absolute left-[-1px] top-[1627px] w-[1920px] h-[232px] bg-[#000] overflow-hidden">
                    ...
                    <div className="absolute left-[390px] top-[62px] w-[638px] h-[115px] flex">
                        <div className="absolute left-0 top-[54px] w-[638px] h-[61px] flex">
                            ...
                            <img className="absolute left-[2px] top-[27px]" width="9" height="8" src="/img/user/copyright (1) 1145_1170.png"></img>
                        </div>
                        <div className="absolute left-0 top-0 w-[221px] h-[21px] text-[15px] leading-[150%] font-['Agdasima'] font-bold text-[#686868]">이용약관              개인정보처리방침</div>
                    </div>
                    <img className="absolute left-[1634px] top-[47px]" width="145" height="34" src="/img/user/Group 17145_1172.png"></img>
                </div>
                <div className="absolute left-0 top-0 w-[1920px] h-[161px] overflow-hidden">
                    <div className="absolute left-0 top-0 w-[1920px] h-[155px] flex">
                        ...
                        <div className="absolute left-[857px] top-0 w-[207px] h-[155px] flex">
                            <img className="absolute left-0 right-0 top-0 bottom-0" width="206" height="154" src="/img/user/bg279_129.png"></img>
                            <img className="absolute left-[2.21%] right-[2.8%] top-0 bottom-[2.63%]" width="196" height="150" src="/img/user/line279_130.png"></img>
                            <div className="absolute left-[24px] top-[6px] w-[159px] h-[123px] flex">
                                ...
                                <img className="absolute left-[24px] top-0" width="111" height="97" src="/img/user/file 1279_133.png"></img>
                            </div>
                        </div>
                    </div>
                ...
                <div className="absolute left-[601px] top-[664px] w-[14px] h-[14px] bg-[#0b2d85] rounded-full"></div>
                ...
                <div className="absolute left-[601px] top-[591px] w-[133px] h-[47px] text-[20px] font-['Inter'] font-semibold text-[#000]">본인인증</div>
                <div className="absolute left-[601px] top-[544px] text-[20px] font-['Inter'] text-[#0b2d85] whitespace-nowrap">STEP 2.</div>
                ...
                <div className="absolute left-[868px] top-[1261px] w-[184px] h-[60px] flex">
                    {/* <div className="absolute left-0 top-0 w-[184px] h-[60px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[50px]"></div>
                    <div className="absolute left-[62px] top-[20px] text-[16px] font-['Inter'] text-[#0b2d85] whitespace-nowrap">인증하기</div> */}
                </div>
                <div className="absolute left-[243px] top-[865px] w-[90px] h-[29px] text-[24px] font-['Inter'] font-semibold text-[#000]">본인인증</div>
            </div>
            <button onClick={openModal}
                className="absolute left-[868px] top-[1268px] w-[184px] h-[60px] bg-[#fff] border-[1px] border-solid border-[#0b2d85] rounded-[50px]"
            >
