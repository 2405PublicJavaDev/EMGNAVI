...
## 김덕영
  ### 프로젝트를 통해 배운 점
  - 다양한 어노테이션을 익히고, 이전에 사용했던 어노테이션에 대해 더 명확하게 이해할 수 있었습니다. 그리고 비지니스 계층을 복습하게 되었습니다.
  - 기능을 구현하면서 Postman과 InteliJ 프로그램을 사용하게 되었고, 그 사용법을 익히게 되었습니다.
  - 래약트 공부를 하면서 공공테이터와 카카오 지도 API를 활용하여 기능을 구현해 볼 수 있어 다양한 학습을 할 수 있었습니다.
  ### 어려웠던 점
  - 지도, 공공데이터, 리액터 등 기능 구현에 필요한 기술들을 공부했지만, 바로 적용하는 것이 쉽지 않았습니다. 완벽히 숙지하지않은 상태에서 진행하게 되어 어려웠던 것 같습니다.
